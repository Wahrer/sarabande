...
bullet: Has no effect on Pokemon with the Bulletproof Ability. Boosted by 1.5x by Mega Launcher.
...
punch: Power is multiplied by 1.5 when used by a Pokemon with the Iron Fist Ability.
recharge: If this move is successful, the user must recharge on the following turn and cannot make a move.
reflectable: Bounced back to the original user by Magic Coat or the Magic Bounce Ability.
snatch: Can be stolen from the original user and instead used by another Pokemon using Snatch.
sound: Has no effect on Pokemon with the Soundproof Ability. Boosted by 1.5x when using the Overdrive ability.
mater: Used to fix Parental Bond.
lumen: Used for "luminous" moves to be boosted by Overglow.
heely: Used for Heal Pulse as a support pulse move.
elesupe: high-yield stuff like Fire Blast and Blizzard
elemid: 90-BP stuff like Flamethrower and Ice Beam
atticus: "eightycus flinch" - 80 base power / flinch buffed moves
...
let BattleMovedex = {
	...
	"airslash": {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, distance: 1, atticus: 1},
		secondary: {
			chance: 20,
	...
	"aquatail": {
		...
		pp: 15,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, elemid: 1},
		secondary: null,
		target: "normal",
		type: "Water",
		zMovePower: 180,
	...
	"astonish": {
		...
		pp: 15,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, atticus: 1},
		secondary: {
			chance: 20,
			volatileStatus: 'flinch',
		},
	...
	"aurasphere": {
		...
		pp: 20,
		priority: 0,
		flags: {pulse: 1, protect: 1, mirror: 1, distance: 1},
		secondary: null,
		target: "any",
		type: "Fighting",
		zMovePower: 160,
	...
	"aurorabeam": {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, atticus: 1, lumen: 1},
		secondary: {
			chance: 20,
			boosts: {
				atk: -1,
	...
	"bite": {
		...
		pp: 15,
		priority: 0,
		flags: {bite: 1, contact: 1, protect: 1, mirror: 1, atticus: 1},
		secondary: {
			chance: 20,
			volatileStatus: 'flinch',
		},
	...
	"blizzard": {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, elesupe: 1},
		onModifyMove(move) {
	...
	"boneclub": {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, atticus: 1},
		secondary: {
			chance: 20,
			volatileStatus: 'flinch',
		},
	...
	"bugbuzz": {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, sound: 1, authentic: 1, elemid: 1},
		secondary: {
			chance: 20,
			boosts: {
				spd: -1,
	...
	"chargebeam": {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, lumen: 1},
		secondary: {
			chance: 70,
			self: {
				boosts: {
	...
	"crunch": {
		...
		pp: 15,
		priority: 0,
		flags: {bite: 1, contact: 1, protect: 1, mirror: 1, elemid: 1},
		secondary: {
			chance: 20,
			boosts: {
				def: -1,
	...
	"darkpulse": {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, pulse: 1, mirror: 1, distance: 1, atticus: 1},
		secondary: {
			chance: 20,
			volatileStatus: 'flinch',
		},
	...
	"dazzlinggleam": {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, elemid: 1, lumen: 1},
		secondary: null,
		target: "allAdjacentFoes",
		type: "Fairy",
		zMovePower: 175,
	...
	"diamondstorm": {
		...
		basePower: 120,
		category: "Physical",
		desc: "Has a 20% chance to raise the user's Defense by 2 stages.",
		shortDesc: "20% chance to raise user's Def by 2 for each hit.",
		id: "diamondstorm",
		isViable: true,
		name: "Diamond Storm",
		pp: 5,
	...
	"discharge": {
		...
		shortDesc: "10% chance to paralyze adjacent Pokemon.",
		id: "discharge",
		isViable: true,
		name: "Discharge",
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, elemid: 1},
		secondary: {
			chance: 10,
			status: 'par',
		},
	...
	"earthpower": {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, nonsky: 1, elemid: 1},
		secondary: {
			chance: 20,
			boosts: {
				spd: -1,
	...
	"energyball": {
		...
		pp: 15,
		priority: 0,
		flags: {bullet: 1, protect: 1, mirror: 1, elemid: 1},
		secondary: {
			chance: 20,
			boosts: {
				spd: -1,
	...
	"focusblast": {
		...
		pp: 5,
		priority: 0,
		flags: {bullet: 1, protect: 1, mirror: 1, elesupe: 1},
		secondary: {
			chance: 10,
			boosts: {
				spd: -1,
	...
	"healpulse": {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, heely: 1, reflectable: 1, distance: 1, heal: 1, mystery: 1},
		onHit(target, source) {
			let success = false;
	...
	"hurricane": {
		...
		shortDesc: "10% chance to confuse target. Can't miss in rain.",
		id: "hurricane",
		isViable: true,
		name: "Hurricane",
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, distance: 1, elesupe: 1},
		onModifyMove(move) {
	...
	"lavaplume": {
		...
		category: "Special",
		desc: "Has a 10% chance to burn the target.",
		shortDesc: "10% chance to burn adjacent Pokemon.",
		id: "lavaplume",
		isViable: true,
		name: "Lava Plume",
		pp: 10,
	...
	"nightshade": {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, mater: 1},
		secondary: null,
		target: "normal",
		type: "Ghost",
		zMovePower: 100,
	...
	"prismaticlaser": {
		...
		pp: 10,
		priority: 0,
		flags: {recharge: 1, protect: 1, mirror: 1, lumen: 1},
		self: {
			volatileStatus: 'mustrecharge',
		},
		secondary: null,
	...
	"scald": {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, defrost: 1, atticus: 1},
		thawsTarget: true,
		secondary: {
			chance: 30,
			status: 'brn',
	...
	"seismictoss": {
		...
		pp: 20,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, nonsky: 1, mater: 1},
		secondary: null,
		target: "normal",
		type: "Fighting",
		zMovePower: 100,
	...
	"snore": {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, sound: 1, authentic: 1, atticus: 1},
		sleepUsable: true,
		onTryHit(target, source) {
	...
	"solarbeam": {
		...
		pp: 10,
		priority: 0,
		flags: {charge: 1, protect: 1, mirror: 1, lumen: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	"solarblade": {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, lumen: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	"stomp": {
		...
		pp: 15,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, nonsky: 1, atticus: 1},
		secondary: {
			chance: 20,
			volatileStatus: 'flinch',
		},
	...
	"thunder": {
		...
		basePower: 110,
		category: "Special",
		desc: "Has a 20% chance to paralyze the target. This move can hit a target using Bounce, Fly, or Sky Drop, or is under the effect of Sky Drop. If the weather is Primordial Sea or Rain Dance, this move does not check accuracy. If the weather is Desolate Land or Sunny Day, this move's accuracy is 50%.",
		shortDesc: "20% chance to paralyze. Can't miss in rain.",
		id: "thunder",
		isViable: true,
		name: "Thunder",
		pp: 5,
	...
	"twister": {
		...
		basePower: 120,
		category: "Special",
		desc: "Has a 10% to lower the target's Attack. Power doubles if the target is using Bounce, Fly, or Sky Drop, or is under the effect of Sky Drop.",
		shortDesc: "10% chance to lower Attack of target(s).",
		id: "twister",
		name: "Twister",
		pp: 5,
		priority: 0,
