...
Config.roomsFirstOpenScript = function (mainMenuOnly) {
	/* eslint-disable */
	if (mainMenuOnly) {
		$('.leftmenu').first().after('<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-6535472412829264" data-ad-slot="7790916938" data-ad-format="auto"></ins>');
		try {
...
Config.customcolors = {
	...
	'nui': 'ant',
	'anubis': 'l99jh',
	'jetou': '04stk', // [16:23:02] %jetou: your original color > any other color 
	'ceteris': 'eprtiuly',
	'om': 'omroom',
	'roman': 'wt2sd0qh',
	'maroon': 'rucbwbeg',
