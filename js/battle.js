...
this.sides;_i17<_this$sides4.length;_i17++){var side=_this$sides4[_i17];for(var _i18=0,_side$active2=
side.active;_i18<_side$active2.length;_i18++){var _active2=_side$active2[_i18];
if(_active2){
_active2.boosts={};
...
_ofpoke8.rememberAbility(_ability.name);
break;
case'powerofalchemy':
case'receiver':
...
_poke28.addVolatile('formechange',_species);for(var _i20=0,_tpoke$moveTrack=
...
this.sides;_i23<_this$sides5.length;_i23++){var _side3=_this$sides5[_i23];for(var _i24=0,_side3$active=
_side3.active;_i24<_side3$active.length;_i24++){var _active3=_side3$active[_i24];
...
if((_active4==null?void 0:_active4.searchid)===searchid&&!isSwitch){
_active4.slot=slot;
return _active4;
}
...
if((_active5==null?void 0:_active5.searchid)===searchid&&!isSwitch){
