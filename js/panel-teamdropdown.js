...
while(true){
var _name=buf.slice(i,buf.indexOf('|',i));
i=buf.indexOf('|',i)+1;

team.push(buf.slice(i,buf.indexOf('|',i))||_name);
...
teams;_i6<_teams.length;_i6++){var _team=_teams[_i6];
var list=teamBuckets[_team.folder]||(teamBuckets[_team.folder]=[]);
list.push(_team);
}
...
PS.teams.list;_i7<_PS$teams$list.length;_i7++){var _team2=_PS$teams$list[_i7];
var gen=_team2.format.slice(0,4);
