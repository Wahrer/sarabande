...
var tokens=BattleTextParser.parseLine(line);
switch(tokens[0]){
case'challstr':
PSLoginServer.query({
act:'upkeep',
...
change=function(){return _this6.forceUpdate();};return _this6;}var _proto5=TeamDropdown.prototype;_proto5.getTeam=function getTeam(){if(this.base){var key=this.base.value;return PS.teams.byKey[key]||null;}var formatid=PS.teams.teambuilderFormat(this.props.format);for(var _i=0,_PS$teams$list=PS.teams.list;_i<_PS$teams$list.length;_i++){var team=_PS$teams$list[_i];if(team.format===formatid)return team;}return null;};_proto5.componentDidMount=function componentDidMount(){var team=this.getTeam();if(team){this.base.value=team.key;}};_proto5.
