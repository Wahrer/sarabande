...
case'send':
case'cmd':
var _room=this.getRoom(elem)||PS.mainmenu;
_room.send(elem.value,elem.name==='send');
return true;}
...
var _room2=PS.rooms[roomid];
if(_room2.location==='left'||_room2.location==='right'){
rooms.push(this.renderRoom(_room2));
}
}
