...
var _species=atIndex>=0?line.slice(0,atIndex).trim():line;
if(_species.endsWith(')')){
var parenIndex=_species.lastIndexOf(' (');
if(parenIndex>=0){
_species=_species.slice(parenIndex+2,-1);
}
}
_this.setInfo.push({
species:_species,
...
if(!cursorOnly){
var _bottomY=_this.getYAt(value.length,value);
if(_this.setInfo.length){
_this.setInfo[_this.setInfo.length-1].bottomY=_bottomY;
}

textbox.style.height=_bottomY+100+"px";
}
_this.forceUpdate();
